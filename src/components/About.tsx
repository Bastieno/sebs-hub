      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center mb-20">
          <div>
            ...
            <div className="space-y-6 text-lg text-gray-600 leading-relaxed">
              <p>
                Seb&apos;s Hub was created out of frustration — the kind that
                comes when you&apos;re ready to do great work but can&apos;t
                find reliable space, power, or peace.
              </p>

              <p>
                We built this place for people like us — freelancers, small
                teams, dreamers, night owls, creators, and remote workers who
                don&apos;t want to be at the mercy of NEPA or noisy cafés.
              </p>

              <p>
                We&apos;re a space that works as hard as you do. Minimalist,
                solar-powered, accessible, and intentionally affordable.
              </p>
        ...
        <div className="hero-gradient rounded-3xl p-8 md:p-12 text-center text-white">
          ...
          <p className="text-xl mb-8 max-w-3xl mx-auto leading-relaxed">
            We&apos;re not your typical coworking space. We are a
            community-powered creative hub built for freelancers, founders,
            remote workers, and doers who want flexible access, steady energy,
